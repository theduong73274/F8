...
const questionApp = {
  questions: [
    {
      title:
        "Ai thấy giao diện mới của web anh Sơn hiện đại tối giản dơ tay nào?! 😁",
      userImg:
        "https://avatar-redirect.appspot.com/google/114408222476873472712?size=400",
      name: "Phuong Quang Tran",
      content:
        "Ai thấy giao diện mới của web anh Sơn vừa hiện đại vừa tối giản dơ tay...",
      user1:
    ...
    {
      title:
        "em mới bắt đầu khóa học thì không biết viết code ở phần mềm gì v ạ. a giúp e vs ạ",
    ...
    },
    {
      ...
      content:
        "Mọi người cho em hỏi là làm thế nào để chữ Ánh's Food kia của em có animation fly in giống ở bên powerpoint...",
      user1:
        "https://avatar-redirect.appspot.com/google/114872706407217018723?size=400",
      user2:
        "https://avatar-redirect.appspot.com/google/114872706407217018723?size=400",
    ...
    },
    {
      ...
      name: "Phaolo Đại",
      content:
        "em chào mội người em tên Đại năm nay em 17t em nghĩ học khi em vừa học hết lớp 8 và em đã đi làm ngoài xã hội từ năm em 14t không biết nếu em theo nghề này...",
    ...
    },
    {
      ...
      name: "Trần Mạnh Tiến",
      content:
        "các bác cho e hỏi xíu ạ, làm thế nào để e có trình edit text như f8 ạ, bác nào biết chỉ em với ạ, hoặc cho e xin keyword e tìm hiểu, em...",
      user1: "https://fullstack.edu.vn/assets/images/nobody_m.256x256.jpg",
      user2:
    ...
    },
    {
      ...
      name: "Nguyễn Thuận",
      content:
        "Mọi người cho em hỏi là có extension trên VS gợi ý code, mình chỉ cần gõ 1 cái là tự động ra luôn mấy dòng lệnh code như ý mình muốn. Anh Sơn có nói ở...",
      user1: "https://fullstack.edu.vn/assets/images/nobody_m.256x256.jpg",
      user2: "https://fullstack.edu.vn/assets/images/nobody_m.256x256.jpg",
      user3: "https://fullstack.edu.vn/assets/images/nobody_m.256x256.jpg",
      comment: 3,
    },
    {
      ...
      name: "Thân Sơn",
      content:
        "Chào mọi người !  Hiện tại mình đang có nhu cầu làm một trang web (hoặc app) có thể check đơn hàng đã giao đi tới đâu giống như check đơn hàng trong...",
      user1: "https://fullstack.edu.vn/assets/images/nobody_m.256x256.jpg",
      user2: "https://fullstack.edu.vn/assets/images/nobody_m.256x256.jpg",
      user3: "https://fullstack.edu.vn/assets/images/nobody_m.256x256.jpg",
      comment: 2,
